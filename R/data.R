...
#' 
#' 
#' @format A vector containing 55 values
#' @references Bjornstad, O. N., M. Begon, N. C. Stenseth, W. Falck, S. M.
#' Sait, and D. J. Thompson. 1998. Population dynamics of the Indian meal moth:
